...
// Mapping nom affiché → id du projet (pour les liens)
export const projectNameToId: Record<string, string> = {
  ...
  "CV-Later": "cv-later",
  Popeye: "popeye",
  "Popeye (worker service)": "popeye",
  "Popeye (result service)": "popeye",
  "Popeye (poll service)": "popeye",
  "Portfolio (Jekyll version)": "portfolio-jekyll",
  "Portfolio (HTML/CSS)": "portfolio-html",
  "Portfolio (versions HTML/CSS & Tailwind)": "portfolio-html",
  "Portfolio (multiple versions)": "portfolio-html",
};
